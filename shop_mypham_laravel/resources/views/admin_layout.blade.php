                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li><a href="{{URL::to('/all-category-product')}}">Tất cả</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li><a href="{{URL::to('/all-brand-product')}}">Tất cả</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li><a href="{{URL::to('/all-product')}}">Tất cả</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="{{URL::to('/add-custom')}}">Thêm khách hàng</a></li>
                            <li><a href="{{URL::to('/all-custom')}}">Tất cả</a></li>
                        </ul>
                    </li>
